...
const features = [
  { icon: 'file', tone: 'blue', title: 'Context-aware AI interviews', text: 'Upload your resume and the job description. InterviewAI creates role-specific questions that actually matter.' },
...
const testimonials = [
  ...
  ['ER', 'Elena R.', 'Marketing Lead', '“Interviewing used to be stressful. Practising with InterviewAI made it feel like a breeze.”'],
]

function HeroVisual() {
  return <div className="hero-visual" aria-label="InterviewAI feedback preview">
    <div className="visual-halo" />
    <div className="ai-panel">
      <div className="panel-topbar"><div className="panel-dots"><i /><i /><i /></div><span>InterviewAI <em>● Live session</em></span><Icon name="spark" size={16} /></div>
    ...
    <div className="feedback-card"><div className="feedback-icon"><Icon name="spark" size={17} /></div><div><small>AI insight</small><p>Strong leadership. Add a specific metric to make this answer <b>40% more impactful.</b></p></div></div>
...
export function Landing() {
  return <>
    <main className="landing-page">
      <section className="landing-hero">
        <div className="container hero-layout">
          <div className="hero-content">
            <span className="eyebrow-badge"><i /> AI-powered career confidence</span>
            <h1>Prepare smarter.<br /><span>Interview better.</span></h1>
            <p className="hero-lede">Master your next interview with personalised AI mock sessions, real-time feedback, and resume-tailored practice questions.</p>
            <div className="hero-cta"><Button to="/register" className="primary-button" endIcon="arrow">Start preparing free</Button><Button href="#how" variant="outline" className="outline-button"><span className="play-small"><Icon name="play" size={12} /></span> See how it works</Button></div>
      ...
      <section className="landing-section faq-section"><div className="container faq-container"><div className="center-heading"><span className="section-kicker">Questions, answered</span><h2>Frequently asked questions.</h2></div><div className="faq-list"><details open><summary>Is InterviewAI specialised for technical roles?<span>+</span></summary><p>Yes. InterviewAI adapts to software engineering, product, marketing, finance, and many other high-demand roles.</p></details><details><summary>Can I use it for free?<span>+</span></summary><p>Absolutely. Every new user gets two full-length mock interviews with reports and feedback.</p></details><details><summary>Does it record my sessions?<span>+</span></summary><p>Sessions are transcribed for analysis, and you have full control over your data. You can delete them at any time.</p></details></div></div></section>
    </main>
    <footer id="contact" className="landing-footer"><div className="container footer-top"><div className="footer-brand"><div className="footer-wordmark">Interview<span>AI</span></div><p>Precision in preparation.<br />Powered by conversational AI.</p></div><div className="footer-links"><div><b>Product</b><a href="#features">Features</a><a href="#how">How it works</a><Link to="/register">Get started</Link></div><div><b>Company</b><a href="#about">About us</a><a href="mailto:hello@interviewai.cm">Contact</a><a href="#">Privacy</a></div><div><b>Based in</b><p>Douala, Cameroon<br />Made for Africa & beyond</p></div></div></div><div className="container footer-bottom"><span>© 2026 InterviewAI. Made with purpose in Cameroon.</span><span>English · Français</span></div></footer>
  </>
}
